...
const openSound = new Audio("sounds/transition.ogg");
const closeSound = new Audio("sounds/over.wav");
const clickSound = new Audio("sounds/click.mp3");
const fadeoutSound = new Audio("sounds/transition.ogg");
...
const OpenMenu = (data) => {
    ...
    let form = ["<form id='qb-input-form'>", `<div class="heading"><img class="icon" src="img/icono.webp" alt="Coords Icon">${data.header != null ? data.header : "Form Title"}</div>`];
